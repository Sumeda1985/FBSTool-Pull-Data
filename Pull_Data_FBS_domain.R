...
if (CheckDebug()) {
  ...
  SETTINGS <- faoswsModules::ReadSettings(file.path("sws_FBS.yml"))
...
if(file.exists(paste0(basedir,"/Data/ShareUpDownTree.csv"))){
  file.remove(paste0(basedir,"/Data/ShareUpDownTree.csv"))
  write.csv(shareUpDownTree,paste0(basedir,"/Data/ShareUpDownTree.csv"),row.names = FALSE)
}else{
  write.csv(shareUpDownTree,paste0(basedir,"/Data/ShareUpDownTree.csv"),row.names = FALSE)
...
if(file.exists(paste0(basedir,"/Data/fbs_standardized_wipe.csv"))){
  file.remove(paste0(basedir,"/Data/fbs_standardized_wipe.csv"))
  write.csv(fbs_standardized,paste0(basedir,"/Data/fbs_standardized_wipe.csv"),row.names = FALSE)
}else{
...
if(file.exists(paste0(basedir,"/Data/fbs_balancedData_wipe.csv"))){
  file.remove(paste0(basedir,"/Data/fbs_balancedData_wipe.csv"))
  write.csv(fbs_balancedData,paste0(basedir,"/Data/fbs_balancedData_wipe.csv"),row.names = FALSE)
}else{
...
if(file.exists(paste0(basedir,"/Data/SuabalData.csv"))){
  file.remove(paste0(basedir,"/Data/SuabalData.csv"))
  write.csv(SuabalData,paste0(basedir,"/Data/SuabalData.csv"),row.names = FALSE)
}else{
...
if(file.exists(paste0(basedir,"/Data/parentNodes.csv"))){
  file.remove(paste0(basedir,"/Data/parentNodes.csv"))
  write.csv(parentNodes,paste0(basedir,"/Data/parentNodes.csv"),row.names = FALSE)
}else{
  write.csv(parentNodes,paste0(basedir,"/Data/parentNodes.csv"),row.names = FALSE)
...
write.csv(fbs_standardized,paste0(basedir,"/Data/fbs_standardized_final.csv") ,row.names=FALSE)
...
write.csv(fbs_balanced_bis,paste0(basedir,"/Data/fbs_balanced_final.csv") ,row.names=FALSE)
...
write.csv(fbs_balancedData_2010_2013,paste0(basedir,"/Data/fbs_balanced_2010_2013.csv") ,row.names=FALSE)
